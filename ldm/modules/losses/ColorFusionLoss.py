...
class fusion_loss(nn.Module):
    ...
    def forward(self, image_fused, image_visible, image_infrared, max_ratio=4, ssim_vis_ratio=1, ssim_ir_ratio=1, ssim_ratio=1, color_ratio=12, text_ratio=10):
        ...
        loss_text = text_ratio * self.loss_func_Grad(image_visible, image_infrared, image_fused)
        total_loss = loss_max + loss_text
        return total_loss
...
class L_Intensity(nn.Module):
    ...
    def forward(self, image_visible, image_infrared, image_fused):
        ...
        mask = (image_infrared > image_visible).float()
